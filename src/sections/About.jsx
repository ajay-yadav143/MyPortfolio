    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        {glows.map((c, i) => (
          <div
            key={i}
            className={`absolute rounded-full bg-gradient-to-r from-[#302b63] via-[#00b8ff] to-[#1cd8d2] animate-pulse ${c}`}
          />
        ))}
      </div>

      {/* Content */}
      <div className="relative z-10 max-w-6xl mx-auto px-6 md:px-10 lg:px-12 py-20 flex flex-col gap-16">
        {/* TOP SECTION */}
        <motion.div
        ...
        >
          ...
          <div className="flex-1 flex flex-col justify-center text-center md:text-left">
            ...
            <p className="mt-4 text-gray-300 leading-relaxed text-base sm:text-lg max-w-3xl">
              ...
              Javascript, React, Next.js, TypeScript, Tailwind CSS, and RESTful APIs —
            ...
            <div className="mt-6 flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center md:justify-start">
              ...
              <a
                href="#contact"
                className="inline-flex items-center justify-center rounded-lg border border-white/20 text-white/90 px-5 py-3 hover:bg-white/20 transition"
              >
                Get in Touch
              </a>
            </div>
        ...
        >
          ...
          <p className="text-gray-300 leading-relaxed text-base sm:text-lg">
            ...
            coding insights on Twitter, Github and Linkedin.
          </p>
